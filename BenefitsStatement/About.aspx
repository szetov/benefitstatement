...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>This application enables Human Resources admnistrators to query employees current benefits.
        It covers employees from various countries in Asia; and therefore some of the important design
        considerations are listed below.
    </p>
    <ul>
        <li>the application must support different regulatory requirements (e.g. annual leave) from 
            different countries.
        </li>
    ...
    <p>
        ...
        logic is implemented by a dedicated strategy subclasses, to avoid use of if-else or switch-case statements. 
    ...
    <p>
        The application is logically separated into multiple layers / components:
    </p>
    <ul>
        <li>The presentation layer (web application project <em>BenefitStatement</em>)</li>
        <li>The business logic layer (namespace <em>BenefitStatement.Bll</em>) contains classes 
            that represent the domain model and implement domain logic
        </li>
        <li>
            ...
            does not use any databases and therefore it only provides a mock implementation.
        </li>
        <li>
    ...
    <ul>
        <li>Instead of one file per class, I have, in certain cases, defined multiple closely related
            ...
            scattered in the project, and also to shorten the list of files in the Solution Explorer 
            of Visual Studio.
        </li>
        <li>
